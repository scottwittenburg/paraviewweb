...
import correlationIcon        from './svg/correlation.svg';
// import stddevIcon             from './svg/stddev.svg';
// import entropyIcon            from './svg/entropy.svg';
import mutualInfoIcon         from './svg/mutualinfo.svg';
  ...
  publicAPI.setContainer = (el) => {
    ...
    if (model.container) {
      ...
      model.radialAxisIcon.append('use')
        .attr('xlink:href', (model.diagramType.toLowerCase() === 'taylor' ? correlationIcon : mutualInfoIcon));
